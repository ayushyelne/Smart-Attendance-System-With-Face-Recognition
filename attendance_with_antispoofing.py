...
def login():
    if username_var.get() == "" or password_var.get() == "":
        ...
        try:
            ...
            curr = conn.cursor()
            curr.execute('select * from login where username = %s and password = %s',
            ...
            if row == None:
                ...
                def manage_students():
                    try:
                        ...
                        print("Hi Ayush Yelne")
                        face = Label(first, text="Management of Students", bg="green", fg="yellow", padx=15, pady=15,
                                     font=("Times New Roman", 20, "bold"), borderwidth=5, relief=RIDGE).place(x=500,
                                                                                                              y=10)
                        ...
                        backbtn = Button(first, text='Back', font=('Times new Roman', 15), fg='black', bg='white',
                                         height=1, width=7, command=back).place(x=1250, y=10)
                                        ...
                                        if (re.search('^[9]\d{9}$', contact_var.get())):
                                            ...
                                            if (re.search(regex, address_var.get())):
                                                ...
                                                if not os.path.exists(input_directory):
                                                    ...
                                                    cur1 = conn.cursor()
                                                    cur1.execute(
                                                        "insert into attendance(roll_no,fname,gender,contact_no,email_address,date_of_join) VALUES (%s,%s,%s,%s,%s,%s)",
                                                        (
                                                            post_var.get(),
                                                            fname_var.get(),
                                                            gender_var.get(),
                                            ...
                                            if (re.search(regex, address_var.get())):
                                                ...
                                                if id in staff_ids:
                                                    ...
                                                    if (q == True):
                                                        ...
                                                        cv2.destroyAllWindows()
                                                        cur.execute(
                                                            "update attendance set department = %s, fname = %s, gender = %s, contact_no = %s, email_address = %s where stdid = %s",
                                                            (
                                                                post_var.get(),
                                                                fname_var.get(),
                                                                gender_var.get(),
                                                        ...
                                                        os.rename(os.path.join(dataset_dir, staff_name),
                        ...
                        def search_data():
                            conn = pymysql.connect(host="localhost", user="root", password="", database="recognition")
                            cur = conn.cursor()
                            cur.execute("select * from attendance where " + str(search_from.get()) + " LIKE '%" + str(
                                search_result.get()) + "%'")
                            data = cur.fetchall()
                            if len(data) != 0:
                                table1.delete(*table1.get_children())
                        ...
                        titles = Label(f2, text="Manage Student", bg="gray", font=("Italic", 20, "bold")).place(x=90,
                                                                                                                 y=30)
                        id = Label(f2, text="Student ID", bg="gray", font=("italic", 13, "bold")).place(x=35, y=100)
                        E1 = Entry(f2, state="disabled", width=20, textvariable=stdid_var,
                                   font=("italic", 13, "bold")).place(x=180, y=100)
                        post = Label(f2, text="Roll No.", bg="gray", font=("italic", 13, "bold")).place(x=35, y=150)
                        ...
                        E3 = Entry(f2, width=20, textvariable=fname_var, font=("italic", 12, "bold")).place(x=180,
                                                                                                            y=200)
                        ...
                        E7 = Combobox(f2, textvariable=gender_var, values=["Male", "Female", "Others"],
                                      state="readonly", font=("italic", 11, "bold")).place(x=180, y=250)
                        no = Label(f2, text="Contact.No", bg="gray", font=("italic", 12, "bold")).place(x=35, y=300)
                        E4 = Entry(f2, width=20, textvariable=contact_var, font=("italic", 12, "bold")).place(x=180,
                                                                                                              y=300)
                        address = Label(f2, text=" Email Address", bg="gray", font=("italic", 12, "bold")).place(x=35,
                                                                                                                 y=350)
                        E5 = Entry(f2, width=20, textvariable=address_var, font=("italic", 12, "bold")).place(x=180,
                                                                                                              y=350)
                        ...
                        btn1 = Button(f3, text="Add", bg="green", height="1", width="7", command=add_students,
                                      font=("Times new Roman", 14, "bold")).place(x=10, y=10)
                        btn2 = Button(f3, text="Update", bg="green", height="1", width="7", command=update,
                                      font=("Times new Roman", 14, "bold")).place(x=105, y=10)
                        btn3 = Button(f3, text="Delete", bg="green", height="1", width="7", command=delete,
                                      font=("Times new Roman", 14, "bold")).place(x=205, y=10)
                        btn4 = Button(f3, text="Clear", bg="green", height="1", width="7", command=clear,
                                      font=("Times new Roman", 14, "bold")).place(x=305, y=10)
                        ...
                        f4.place(x=440, y=90)
                        l1 = Label(first, text="Search By:", font=("times new roman", 18, "bold"), bg="gray",
                                   fg="white").place(x=460, y=100)
                        c1 = Combobox(first, textvariable=search_from, values=["stdid", "fname", "post"],
                                      state="readonly", width="25").place(x=580, y=109)
                        E7 = Entry(first, textvariable=search_result, width="25", font=("times new Roman", 10)).place(
                            x=780, y=109)
                        btn7 = Button(first, text="Search ", height="1", width="16", command=search_data,
                                      font=("Times new Roman", 13, "bold")).place(x=960, y=100)
                        btn8 = Button(first, text="Show All", height="1", width="16", command=show_data,
                                      font=("Times new Roman", 13, "bold")).place(x=1150, y=100)
                        ################################################################################## Table frame
                        ...
                        table1 = Treeview(f5,
                                          columns=("stdid", "post", "fname", "gender", "contact.no", "address", "DOJ"),
                ...
                def train():
                    try:
                        ...
                        train_title = Label(second, text="Train the System", fg='white',
                                            font=("times new roman", 20, "bold"), bg="brown")
                        ...
                        backbtn = Button(second, text='Back', fg='black', bg='white', font=('Times new roman', 15),
                                         height=1, width=7, command=back).place(x=1260, y=3)
                        ...
                        btn = Button(second, text="Start Training", fg='white', font=("Times new roman", 20, "bold"),
                                     command=progress, bg="green")
                ...
                def face_recognize():
                    ...
                    if os.path.exists(embeddings_model_file and recognizer_model_file):
                        ...
                        if final_label == "real":
                            ...
                            status = "Present"
                            cur1 = conn.cursor()
                            cur1.execute("select name,date from report where name = %s and date = %s",
                                         (final_name, date))
                            data = cur1.fetchall()
                            if len(data) != 0:
                                ...
                                if (int(time_hour) >= start_hour and int(time_hour) <= end_hour):
                                    cur2 = conn.cursor()
                                    cur2.execute("insert into report(id,name,date,time,status) VALUES (%s,%s,%s,%s,%s)",
                                                 (final_id,
                                                  final_name,
                                                  date,
                                                  time,
                ...
                def change():
                    ...
                    title = Label(account_frame, text="Admin Account", font=('times new roman', 20, 'bold'), fg='green',
                                  bd=3, relief=SUNKEN)
                    ...
                    newpass_var = StringVar()
                    backbtn = Button(account, text='Back', bg="gray", fg="white", font=("Times New Roman", 13, "bold"),
                                     borderwidth=1, relief=RIDGE, command=back).place(x=445, y=7)
                    ...
                    pass_label = Label(account_frame, text='Old Password', font=('times new roman', 14, 'bold')).place(
                        x=55, y=215)
                    ...
                    user_label = Label(account_frame, text='New Username', font=('times new roman', 14, 'bold')).place(
                        x=55, y=275)
                    ...
                    btn = Button(account_frame, text='Reset', font=('times new roman', 14, 'bold'), width=10,
                                 bg='green', command=user_change, relief=GROOVE).place(x=240, y=380)
                    account.mainloop()
                ...
                def report():
                    ...
                    title_label = Label(title, text="Attendance Report", font=("times new roman", 30, "bold"),
                                        fg="white", bg="maroon")
                    title_label.pack()
                    ...
                    backbtn = Button(title, text='Back', bg="blue", fg="white", font=("Times New Roman", 20, "bold"),
                                     relief=RIDGE, command=back).place(x=1250, y=0)
                    ...
                    search_label = Label(text_fill, text="Search By:", font=("times new roman", 15, "bold"),
                                         bg="yellow")
                    search_label.place(x=10, y=13)
                    search_combo = Combobox(text_fill, textvariable=search_by, values=['date', 'name'],
                                            state='readonly', font=("times new roman", 15), width=15)
                    ...
                    search_btn = Button(text_fill, text="Search", font=("times new roman", 15, "bold"),
                                        command=search_data, width=15)
                    search_btn.place(x=540, y=10)
                    search_today = Button(text_fill, text="Delete", font=("times new roman", 15, "bold"),
                                          command=delete_data, width=15)
                    ...
                    report_table = Treeview(table_frame, columns=("ID", "Name", "Date", "Time", "Status"),
                                            xscrollcommand=scroll_x.set, yscrollcommand=scroll_y.set)
                    scroll_x.pack(side=BOTTOM, fill=X)
                    scroll_y.pack(side=RIGHT, fill=Y)
                ...
                def photo_samples():
                    global my_image
                    attendance.photo_paths = filedialog.askopenfilename(initialdir='./dataset', title="Select Photo",
                                                                        filetypes=(
                ...
                def face_embedding():
                    ...
                    backgrd.pack()
                    embed_title = Label(fe, text="Extract And Save Embeddings", font=("times new roman", 30, "bold"),
                                        bg="brown")
                    ...
                    if not os.path.exists(embeddings_model_file):
                        ...
                        def start_extracting_embedding(pixels):
                            ...
                            data = {"paths": image_paths, "names": names, "face_ids": face_ids, "imageIDs": image_ids,
                        ...
                        btn = Button(fe, text="Start Extracting Embeddings", fg='white',
                                     ...
                                     command=lambda: start_extracting_embedding(pixels=face_pixels), bg="green")
                        ...
                        if data is not None:
                            ...
                            Button(fe, text='Back', fg='White', bg='green',
                                             font=('times new roman', 18, 'bold'), command=back).place(x=1250, y=1)
                            l = len(face_pixels)
                            percent = StringVar()
                            text = StringVar()
                ...
                topic = Label(attendance, text=manage, bg="blue", fg="yellow", padx=15, pady=15,
                              font=("Times New Roman", 20, "bold"), borderwidth=5, relief=RIDGE)
                topic.place(x=0, y=0, relwidth=1)
                # faceslider()
                # faceslidercolor()

                photo1 = PhotoImage(file="Photos/management.png", master=attendance)
                B1 = Button(attendance, image=photo1, text="Student Management", font=("Times New Roman", 15),
                            fg="green", height=230, width=265, command=manage_students, compound=BOTTOM)
                B1.place(x=20, y=100)

                photo2 = PhotoImage(file="Photos/face_recognizer.png", master=attendance)
                B2 = Button(attendance, image=photo2, text="Face Recognizer", font=("Times new roman", 15), fg="green",
                            height=230, width=265, command=face_recognize, compound=BOTTOM)
                B2.place(x=20, y=400)
                photo3 = PhotoImage(file="Photos/train.png", master=attendance)
                B3 = Button(attendance, image=photo3, text="Train the Data", font=("Times new roman", 15), fg="green",
                            height=230, width=265, command=train, compound=BOTTOM)
                B3.place(x=360, y=100)
                photo4 = PhotoImage(file="Photos/exit1.png", master=attendance)
                B4 = Button(attendance, text="Exit", image=photo4, fg="green", font=("Times new Roman", 15), height=230,
                            width=265, command=exit, compound=BOTTOM)
                B4.place(x=1040, y=400)
                photo5 = PhotoImage(file="Photos/report.png", master=attendance)
                B5 = Button(attendance, text="Attendance Report", fg="green", font=("Times new roman", 15),
                            image=photo5, height=230, width=265, command=report, compound=BOTTOM)
                B5.place(x=360, y=400)
                photo6 = PhotoImage(file="Photos/photosample.png", master=attendance)
                B6 = Button(attendance, text="Photo Samples", fg="green", font=("Times new roman", 15), image=photo6,
                            height=230, width=265, command=photo_samples, compound=BOTTOM)
                B6.place(x=700, y=100)
                photo7 = PhotoImage(file="Photos/passwordchange.png", master=attendance)
                B7 = Button(attendance, text="Admin Account", fg="green", font=("Times new roman", 15), image=photo7,
                            height=230, width=265, command=change, compound=BOTTOM)
                B7.place(x=700, y=400)
                photo8 = PhotoImage(file="Photos/embeddings.png", master=attendance)
                B8 = Button(attendance, text="Extract Embeddings", fg="green", font=("Times new Roman", 15),
                            image=photo8, height=230, width=265, command=face_embedding, compound=BOTTOM)
...
title = Label(face, text="Admin Login Page", font=("times new roman", 30, "bold"), bg="green", fg="yellow", bd=7,
              relief=GROOVE)
...
user_label = Label(login_frame, text="Username", image=user_icon, bg="white", compound=LEFT,
                   font=("times new roman", 15, "bold")).grid(row=1, column=0, padx=30, pady=5)
user_entry = Entry(login_frame, font=("times new roman", 15, "bold"), relief=GROOVE, textvariable=username_var,
                   bg="lightgray").grid(row=1, column=1, padx=10, pady=5)
...
password_entry = Entry(login_frame, show="*", font=("times new roman", 15, "bold"), relief=GROOVE,
                       textvariable=password_var, bg="lightgray").grid(row=2, column=1, padx=20, pady=5)
submit_btn = Button(login_frame, text="Log In", width=10, activebackground="blue", activeforeground="white",
                    command=login, font=("times new roman", 20, "bold"), relief=GROOVE, bg="green").grid(row=3,
                                                                                                         column=1,
                                                                                                         pady=25,
                                                                                                         padx=25)
face.mainloop()
